...
function exibirReceitaPorId(id) {
    ...
    if (receita) {
        ...
        var tempoRendimentoDificuldade = document.createElement("h2");
        tempoRendimentoDificuldade.innerHTML = "Tempo: " + receita.tempo + " - Rendimento: " + receita.rendimento + " - Dificuldade: " + receita.dificuldade;
        receitaDiv.appendChild(tempoRendimentoDificuldade);
        
        var imagemReceita = document.createElement("div");
        imagemReceita.classList.add("comida");
        ...
        receita.ingredientes.forEach(function(ingrediente) {
            ...
            p.innerText = ingrediente.quantidade + " " + ingrediente.ingrediente;
